...
function tellMe(joke){
    ...
    VoiceRSS.speech({
        key: '1862449d0450464d8142585d70a763bc',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getjokes(){
    ...
    const jokeUrl='https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&idRange=0-185';
    try {
